...
function Footer() {
  return (
    <footer className="bg-zinc-800 text-white text-center py-6 shadow-md shadow-gray-100">
        ...
        <section>
          <form>
            <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4">
              ...
              <button type="submit" className="bg-[#f23064] text-white px-4 py-2 rounded-md font-semibold hover:bg-gray-200 text-zinc-800 transition">
                Subscribe
              </button>
            </div>
          </form>
      ...
      <div className="mt-4 bg-[#f23064] py-3">
        <p>
          &copy; 2025 Copyright: 
          <a className="font-bold text-white" href="https://yourwebsite.com/"> OtterMap.com</a>
        </p>
      </div>
    </footer>
  );
